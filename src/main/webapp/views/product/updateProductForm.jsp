...
<div class="container">
    ...
    <form action="/product" method="post">
        ...
        <input type="text" id="image" name="image" required value="${product.image}">
        ...
        <input type="text" id="producer" name="producer" required value="${product.producer}">
        ...
        <div class="btn-group">
            <p>Status:</p>
            <label for="active">
                <input type="radio" name="status" id="active" value="true" ${product.status ? "checked" : ""}  required style="display: none"> Active
            </label>
            <label for="inactive">
                <input type="radio" name="status" id="inactive" value="false" ${!product.status ? "checked" : ""}  required style="display: none"> Inactive
            </label>
        </div>
